# Simon-Game
## Introduction
Simon Game is developed for learning Git workflows.
 where players must repeat a sequence of colors in the correct order. As the game progresses, the sequence becomes longer and more challenging.
